...
const projects = [
  ...
  },
  {
    ...
    title: "Project Two",
    description:
      "This is a description of project two using some technologies.",
    image: "/projects/placeholder.png",
  ...
  },
  {
    ...
    title: "Project Three",
    description:
      "This is a description of project three using some technologies.",
    image: "/projects/placeholder.png",
              ...
              <div className="p-6">
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.tags.map((tag, key) => (
                    <span
                      key={key}
                      className="px-2 py-1 border border-primary/80 text-xs font-medium rounded-full bg-secondary text-secondary-foreground"
                    >
                      {tag}
                    </span>
                  ))}
